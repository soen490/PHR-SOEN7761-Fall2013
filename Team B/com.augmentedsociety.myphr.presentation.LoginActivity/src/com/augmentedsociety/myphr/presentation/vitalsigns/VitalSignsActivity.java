...
public class VitalSignsActivity extends MenuActivity
{
	...
	public boolean bloodSugarcheck=false;
	public boolean o2check=false;
	public boolean pressurecheck=false;
	...
	public void saveCurrentData()
	{
		...
		if (mLastBloodSugarAct != null){
			bloodSugarcheck=true;
			mLastBloodSugarAct.submit(iView, mDate);
		}
		else bloodSugarcheck=false;
		findAllMeasurementValues(getApplicationContext());
	}
	...
	public boolean bloodsugarischecked()
	{
		boolean checked=false;
		if(bloodSugarcheck==true)
		{
			checked=true;
		}
		else{
	...
	public boolean pressureischecked()
	{
		boolean checked=false;
		if(pressurecheck==true)
		{
			checked=true;
		}
		else{
