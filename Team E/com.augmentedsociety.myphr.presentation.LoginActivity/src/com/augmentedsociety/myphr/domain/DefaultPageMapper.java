...
public class DefaultPageMapper extends ReadingDataMapper
{
  ...
  public static void update(String page, Context iContext) throws MapperException
  {
    try
    {
    	...
    	//values.add("1");
    	values.add(String.valueOf(PatientInfo.mID));
      values.add(page);
  ...
  public static void insert(String page, Context iContext) throws MapperException
  {
    try
    {
      ...
      DefaultPageTDG.insert(values, iContext);
